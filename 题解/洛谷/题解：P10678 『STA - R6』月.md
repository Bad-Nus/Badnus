# 题面
[P10678『STA - R6』月](/%E9%A2%98%E9%9D%A2/%E6%B4%9B%E8%B0%B7%E9%A2%98%E9%9D%A2/P10678%E3%80%8ESTA%20-%20R6%E3%80%8F%E6%9C%88.md#p10678-sta---r6%E6%9C%88)

![[../../题面/洛谷题面/P10678『STA - R6』月|P10678『STA - R6』月]]
# 分析
> 设树集 $T$,构造树集 $T'$,树节点树 $n$,根节点 $R$,且树集 $T'$ 的每个叶子结点的深度 $l_j$,最深节点深度 $l_{max}$,非严格次深节点深度 $l_{max}'$,树的直径子集 $T_h$,树的直径长 $h$.
> 
> 求树的最小的**两节点之间最大距离** $\text{diam}({T'})$ 等价于最小的构造树 $T'$ 的直径长即
> $$\text{diam}(T')=h_{min}=l_{max}+l'_{max}$$
> 
> 有 $h_{min}\le 2l_{max}$, $R\in T_h\in T'$
