...
class QuickLatexSettingTab extends obsidian.PluginSettingTab {
    ...
    display() {
        ...
        containerEl.empty();
        containerEl.createEl('h2', { text: 'Obsidian 快速 LaTeX - 设置' });
        new obsidian.Setting(containerEl)
            .setName('自动关闭 $ 符号')
            .setDesc('输入一个 $ 符号会自动与另一个 $ 符号配对' +
            '(最好与 "在 $ 符号之间移动光标" 功能一起使用')
        ...
        new obsidian.Setting(containerEl)
            .setName('内联和块数学的快捷方式')
            .setDesc('启用内联（$...$）和块级（$...$）数学公式的键盘快捷键。' +
            '默认: 在行内使用ctrl+m (max: cmd+m)，在块中使用ctrl+shift+m (max: cmd+shift+m) ')
            .addToggle((toggle) => {
        ...
        new obsidian.Setting(containerEl)
            .setName('在 $ 符号之间移动光标')
            .setDesc('连续输入两个$符号将自动将光标移至$符号之间。')
            .addToggle((toggle) => toggle
        ...
        new obsidian.Setting(containerEl)
            .setName('将选中的表达式用数学符号$括起来')
            .setDesc('选择一个表达式并按下“$”键会自动' +
            '将表达式用数学符号括起来.')
            .addToggle((toggle) => toggle
        ...
        new obsidian.Setting(containerEl)
            .setName('在"\\sum"后自动添加"\\limits"')
            .setDesc('输入"\\sum"会自动添加"\\limits"以简化语法。' +
            ' 以正确显示求和符号的界限.')
            .addToggle((toggle) => toggle
        ...
        new obsidian.Setting(containerEl)
            .setName('自动放大包含 \\sum、\\int 或 \\frac 的括号')
        ...
        new obsidian.Setting(containerEl)
            .setName('在上标后自动用{}括起表达式')
            .setDesc('在上标“^”符号后输入表达式，然后按空格键' +
            '将自动用"{}"包围表达式')
            .addToggle((toggle) => toggle
        ...
        new obsidian.Setting(containerEl)
            .setName('下标后自动用{}括起表达式')
            .setDesc('在下标 "_" 符号后输入表达式，然后按空格键' +
            '将自动用"{}"包围表达式. ' +
            '注意: 超过10个字符的表达式将被忽略')
            .addToggle((toggle) => toggle
        ...
        new obsidian.Setting(containerEl)
            .setName('输入“/”而不是\\frac{}{}')
            .setDesc('使用“/”符号快速输入分数。例如，输入“1/2”后按空格键。' +
            '转换为 \\frac{1}{2}')
            .addToggle((toggle) => toggle
        ...
        new obsidian.Setting(containerEl)
            .setName('对齐块的快捷方式')
            .setDesc('使用快捷键快速插入 \\begin{align*} \\end{align*} 块。' +
            '默认: "Alt+Shift+A" (Mac: "Option+Shift+A")')
            .addToggle((toggle) => toggle
        ...
        new obsidian.Setting(containerEl)
            .setName('对齐块参数')
            .setDesc('在\\begin{parameter}和\\end{parameter}中设置文本参数。')
            .addText((text) => text
            .setPlaceholder('默认：对齐*')
        ...
        new obsidian.Setting(containerEl)
            .setName('【新功能！】自动对齐这些符号')
            .setDesc('在对齐块内，这些符号前会自动添加对齐符号 "&"。（以空格分隔）')
            .addText((text) => text
        ...
        new obsidian.Setting(containerEl)
            .setName('快捷方式用于案例块')
            .setDesc('使用快捷键快速插入 \\begin{cases} \\end{cases} 块。' +
            '默认: "Alt+Shift+C" (Mac: "Option+Shift+C")')
            .addToggle((toggle) => toggle
        ...
        new obsidian.Setting(containerEl)
            .setName('在对齐和cases块中使用shift-enter进行换行')
            .setDesc('对于上方的对齐和cases块，按回车键会自动添加换行符号"\\"或"&"。切换到此处使用shift-enter代替。')
            .addToggle((toggle) => toggle
        ...
        new obsidian.Setting(containerEl)
            .setName('矩阵块快捷方式')
            .setDesc('使用快捷键快速插入 \\begin{pmatrix} \\end{pmatrix} 块。' +
            '默认: "Alt+Shift+M" (Mac: "Option+Shift+M")')
            .addToggle((toggle) => toggle
        ...
        new obsidian.Setting(containerEl)
            .setName('希腊符号数学模式')
            .setDesc('自动在数学模式外插入的希腊字符命令周围添加数学字符。' +
            '例如，在数学模式外输入“\\alpha”后跟空格将被替换为“$\alpha$”"')
            .addToggle((toggle) => toggle
        ...
        new obsidian.Setting(containerEl)
            .setName('自定义速记')
            .setDesc('使用自定义缩写（可以是多个字母）来表示常见的LaTeX字符串。' +
            '例如，键入“al”后按“空格/制表符”!键将替换为“\\alpha”')
            .addToggle((toggle) => toggle
        ...
        new obsidian.Setting(containerEl)
            .setName('使用Tab键完成自定义简写')
            .setDesc('使用Tab键而不是空格来完成自定义速记。')
            .addToggle((toggle) => toggle
